    ...
    def Get_Sim_Param(self, X_Array, Filter):
        ...
        if Calc_Until > 0:
            with tf.GradientTape(persistent=True) as tape:
                ...
                #Temp1   = 20. * tf.math.exp(-tf.square(x) / 4. / self.alpha) + 30.
                T = All_Var[:, 0:1] * self.Out_Dev[0][0] + self.Out_Dev[0][1]
